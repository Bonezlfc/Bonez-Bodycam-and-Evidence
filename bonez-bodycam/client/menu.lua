...
local bodycamMenu = RageUI.CreateMenu('BODYCAM', 'Configure settings')
...
RageUI.CreateWhile(0, function()
    ...
    -- Auto-close if the player goes off police shift while menu is open
    ...
    RageUI.DrawContent({ header = true, glare = true, instructionalButton = true }, function()
        ...
        -- ── Unit ID ────────────────────────────────────────────
        -- If Night Shifts has a callsign set, show it as read-only.
        -- Otherwise show the manual input button.
        ...
        -- ── Service Type ───────────────────────────────────────
        -- Always show the list for manual selection.
        -- ERS and Night Shifts MDT take priority at runtime via
        -- GetActiveServiceType() — the selection here is the fallback.
